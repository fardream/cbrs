...
func (m Logon) GetCancelOrdersOnDisconnect() (v enum.CancelOrdersOnDisconnect, err quickfix.MessageRejectError) {
	var f field.CancelOrdersOnDisconnectField
	if err = m.Get(&f); err == nil {
		v = f.Value()
	}
	return
