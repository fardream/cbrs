...
func New(clordid field.ClOrdIDField, symbol field.SymbolField, side field.SideField, transacttime field.TransactTimeField, ordtype field.OrdTypeField) (m NewOrderSingle) {
...
func (m NewOrderSingle) SetQuoteRequestType(v enum.QuoteRequestType) {
...
func (m NewOrderSingle) SetSelfTradePrevention(v enum.SelfTradePrevention) {
...
func (m NewOrderSingle) GetQuoteRequestType() (v enum.QuoteRequestType, err quickfix.MessageRejectError) {
...
func (m NewOrderSingle) GetSelfTradePrevention() (v enum.SelfTradePrevention, err quickfix.MessageRejectError) {
...
func (m NewOrderSingle) HasQuoteRequestType() bool {
...
func (m NewOrderSingle) HasSelfTradePrevention() bool {
