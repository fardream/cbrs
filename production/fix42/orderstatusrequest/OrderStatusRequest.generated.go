...
func New(clordid field.ClOrdIDField, symbol field.SymbolField) (m OrderStatusRequest) {
...
func (m OrderStatusRequest) GetSymbolSfx() (v string, err quickfix.MessageRejectError) {
