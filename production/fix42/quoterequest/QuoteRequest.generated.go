...
func (m NoRelatedSym) SetMiscFeeBasis(v enum.MiscFeeBasis) {
	m.Set(field.NewMiscFeeBasis(v))
}

// SetMiscFeeAmt sets MiscFeeAmt, Tag 137.
func (m NoRelatedSym) SetMiscFeeAmt(value decimal.Decimal, scale int32) {
...
func (m NoRelatedSym) GetTradingSessionID() (v string, err quickfix.MessageRejectError) {
...
func (m NoRelatedSym) GetMiscFeeBasis() (v enum.MiscFeeBasis, err quickfix.MessageRejectError) {
...
func (m NoRelatedSym) GetMiscFeeAmt() (v decimal.Decimal, err quickfix.MessageRejectError) {
