...
func New(origclordid field.OrigClOrdIDField, clordid field.ClOrdIDField, symbol field.SymbolField, side field.SideField, transacttime field.TransactTimeField, ordtype field.OrdTypeField) (m OrderCancelReplaceRequest) {
...
func (m OrderCancelReplaceRequest) GetSymbolSfx() (v string, err quickfix.MessageRejectError) {
...
func (m OrderCancelReplaceRequest) GetExDestination() (v string, err quickfix.MessageRejectError) {
